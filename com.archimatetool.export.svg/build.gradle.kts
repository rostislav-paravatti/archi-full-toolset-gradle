...
description = "com.archimatetool.export.svg"
...
implementation(files("lib/org.eclipse.nebula.widgets.gallery.source_1.0.0.201812241324.jar"))
implementation(files("lib/org.eclipse.nebula.widgets.gallery_1.0.0.201812241324.jar"))
implementation(files("lib/org.eclipse.nebula.widgets.grid.source_1.0.0.201706221838.jar"))
implementation(files("lib/org.eclipse.nebula.widgets.grid_1.0.0.201706221838.jar"))
  //compile files('lib/local-lib-sources.jar')

implementation(files("lib/batik-all-1.17.jar"))
implementation(files("lib/commons-io-2.14.0.jar"))
implementation(files("lib/fop-transcoder-allinone-2.9.jar"))
implementation(files("lib/xml-apis-ext-1.3.04.jar"))
implementation(files("lib/xmlgraphics-commons-2.9.jar"))
}
